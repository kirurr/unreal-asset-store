	...
	<body class="justify-normal">
		...
		<main>
			<section class="max-w-screen-md text-center">
				...
				<form class="my-8" action="/admin/assets/<?php echo $asset_id ?>/images/" method="post" enctype="multipart/form-data">
					...
					<input required class="mx-auto block lg:!w-fit" type="file" name="images[]" accept="image/*" multiple>
					<button class="button mt-2 mx-auto" type="submit">add images</button>
				</form>
				<a href="/admin/assets/<?= $asset->id ?>" class="link">back to asset</a>
			</section>
			<section class="max-w-screen-md pt-0">
				...
				<div class="p-2 rounded-xl bg-secondary-bg-color/50 shadow-lg mb-4">
					...
					<div>
						...
						<form class="flex flex-col gap-4 mt-4" action="/admin/assets/<?= $asset_id ?>/images/" method="post" enctype="multipart/form-data">
				...
				<ul class="flex flex-col gap-4 list-none">
					...
					<li class="p-2 rounded-xl bg-secondary-bg-color/50 shadow-lg">
						<div>
							...
							<form class="flex gap-4 mt-4 items-center" action="/admin/assets/<?= $asset_id ?>/images/" method="post" enctype="multipart/form-data">
								<input type="hidden" name="_method" value="put">
