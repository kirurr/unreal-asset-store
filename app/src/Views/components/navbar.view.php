	...
	<ul class="navbar grid grid-cols-3 justify-items-center py-4 px-16 rounded-lg gap-6">
		...
		<div class="flex gap-6">
			<li class="sublist-wrapper">
				...
				<ul class="sublist">
					<li><a class="navbar-link" tabindex="-1" href="/assets">All</a></li>
					<li><a class="navbar-link" tabindex="-1" href="/assets?byNew=on">New</a></li>
					<li><a class="navbar-link" tabindex="-1" href="/assets?byNew=on&ByPopular=on&interval=30">Trending</a></li>
					<li><a class="navbar-link" tabindex="-1" href="/assets?byPopular=on">Top files (all time)</a></li>
					<li><a class="navbar-link" tabindex="-1" href="/assets?byFree=on">Free assets</a></li>
				</ul>
			</li>
			<li class="sublist-wrapper">
				...
				<ul class="sublist">
					...
					<li><a class="navbar-link" href="/assets/?category_id=<?= $category->id ?>"><?= $category->name ?></a></li>
					<?php endforeach; ?>
