		...
		<div class="w-[80%]">
			<div class="size-full flex flex-col relative rounded-xl overflow-hidden">
				...
				<div class="mt-auto w-full relative z-10 p-8">
					...
					<a href="assets/<?= $topAsset->id ?>" class="mt-12 button hover:bg-accent-color/80 hover:text-secondary-font-color/80 bg-accent-color text-secondary-font-color">See details</a>
				</div>
			</div>
		</div>
